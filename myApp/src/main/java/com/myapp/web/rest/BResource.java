...
public class BResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(BResource.class);
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<B>> getB(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteB(@PathVariable("id") Long id) {
